...
public OnGameModeInit()
{
	...
	COASMTI(19539, 1427.99133, -3491.32935, 12.51630,   0.00000, 0.00000, 180.00000, objdistance, 0, 3915, "libertyhi3", "mp_snow", 0, 5);
	...
	CreateObjectAndMaterial(19550, 1225.48242, -3942.52588, 12.51630,   0.00000, 0.00000, 0.0000000, objdistance, 0, 3915, "libertyhi3", "mp_snow", 0);
	...
	CreateObjectAndMaterial(19534, 1155.49097, -3592.57153, 12.34880,   0.00000, 0.00000, 0.00000, objdistance, 0, 3975, "lanbloke", "parking1plain", 0);
	//µÀÂ·
	...
	CreateObjectAndMaterial(19532, 1645.45581, -4152.50537, 12.34880,   0.00000, 0.00000, 90.00000, objdistance, 0, 3975, "lanbloke", "parking1plain", 0);
	...
	CreateObjectAndMaterial(4850, 1315.62683, -3934.75854, 15.26320,   0.00000, 0.00000, -180.00, objdistance, 15,3915, "libertyhi3", "mp_snow", 0);
	...
	CreateObjectAndMaterial(714, 1504.54102, -3995.64307, 10.83200,   0.00000, 0.00000, 0.00000, objdistance, 1, 3915, "libertyhi3", "mp_snow", 0);
	...
	CreateObjectAndMaterial(8513, 1508.91943, -3662.51929, 16.73780,   0.00000, 0.00000, 0.00000, objdistance, 5, 3915, "libertyhi3", "mp_snow", 0);
	...
	CreateDynamicObjectEx(7504, 1489.24414, -4144.49609, 14.10490,   0.00000, 0.00000, 0.00000, objdistance, objdistance);
	...
	CreateObjectAndMaterial(979, 1147.87659, -3871.15430, 12.34440,   0.00000, 0.00000, -90.00000, objdistance, 0, 3915, "libertyhi3", "mp_snow", 0);
	...
	CreateDynamicObjectEx(1231, 1493.04443, -3912.20630, 15.62464,   0.00000, 0.00000, 0.00000, objdistance, objdistance);
	...
	CreateDynamicObjectEx(1231, 1724.09009, -3945.46704, 15.19490,   0.00000, 0.00000, 0.00000, objdistance, objdistance);
	...
	CreateDynamicObjectEx(1231, 1227.43860, -3741.16260, 15.19490,   0.00000, 0.00000, 0.00000, objdistance, objdistance);
	...
	CreateDynamicObjectEx(1231, 1566.61450, -3863.69702, 15.19490,   0.00000, 0.00000, 0.00000, objdistance, objdistance);
	...
	CreateDynamicObjectEx(1231, 1164.37817, -4144.00488, 15.19490,   0.00000, 0.00000, 0.00000, objdistance, objdistance);
	...
	CreateDynamicObjectEx(1231, 1705.98596, -4143.35742, 15.19490,   0.00000, 0.00000, 0.00000, objdistance, objdistance);
	CreateDynamicObjectEx(1231, 1706.60339, -4021.58423, 15.19490,   0.00000, 0.00000, 0.00000, objdistance, objdistance);
	CreateDynamicObjectEx(1231, 1658.20654, -4021.40649, 15.19490,   0.00000, 0.00000, 0.00000, objdistance, objdistance);
	CreateDynamicObjectEx(1231, 1602.18262, -4021.48633, 15.19490,   0.00000, 0.00000, 0.00000, objdistance, objdistance);
	CreateDynamicObjectEx(1231, 1556.14551, -4021.74463, 15.19490,   0.00000, 0.00000, 0.00000, objdistance, objdistance);
	CreateDynamicObjectEx(1350, 1427.75317, -3740.30859, 12.50720,   0.00000, 0.00000, 180.00000, objdistance, objdistance);
	CreateDynamicObjectEx(1350, 1443.18738, -3740.50049, 12.50720,   0.00000, 0.00000, 0.00000, objdistance, objdistance);
	CreateDynamicObjectEx(1350, 1443.11804, -3863.72412, 12.50720,   0.00000, 0.00000, 0.00000, objdistance, objdistance);
	CreateDynamicObjectEx(1350, 1428.32947, -3864.29199, 12.50720,   0.00000, 0.00000, 180.00000, objdistance, objdistance);
	printf("ÒÑ¼ÓÔØ[%d]¸ö´øÎÆÀíµÄOBJECT.",count);
	return 1;
}
...
{
    if(strcmp(cmdtext,"/vehicle",true)==0)
    {
        CreateVehicle(vehicleids, test_pos[0][pos_x], test_pos[0][pos_y], test_pos[0][pos_z], 0, -1, -1, 100);
        SetPlayerPos(playerid, test_pos[0][pos_x], test_pos[0][pos_y], test_pos[0][pos_z]+3);
        return 1;
	}
...
{
	SetPlayerPos(playerid, test_pos[0][pos_x], test_pos[0][pos_y], test_pos[0][pos_z]);
	SetPlayerCameraPos(playerid, test_pos[0][pos_x], test_pos[0][pos_y], test_pos[0][pos_z]);
	SetPlayerCameraLookAt(playerid, test_pos[0][pos_x], test_pos[0][pos_y], test_pos[0][pos_z]);
	return 1;
}
stock COASMTI(modelid, Float:x, Float:y, Float:z, Float:rx, Float:ry, Float:rz, Float:distance, materialindex, materialmodelid, txdname[], texturename[], materialcolor, toindex)//CreateObjectAndSetMaterialToIndex
{
    new id = CreateDynamicObjectEx(modelid, x, y, z, rx, ry, rz, distance, distance);
    for(new i = materialindex; i < toindex; i++)
    {
		SetDynamicObjectMaterial(id, i, materialmodelid, txdname, texturename, materialcolor);
	}
	count ++;
}
stock CreateObjectAndMaterial(modelid, Float:x, Float:y, Float:z, Float:rx, Float:ry, Float:rz, Float:distance, materialindex, materialmodelid, txdname[], texturename[], materialcolor)
{
	new id = CreateDynamicObjectEx(modelid, x, y, z, rx, ry, rz, distance, distance);
